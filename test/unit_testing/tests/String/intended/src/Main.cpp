...
void Main::main() {
	...
	Main::assert((*HxString::split("Hello BLAworld BLA how areBLAyou?"s, "BLA"s)) == (*std::make_shared<std::deque<std::string>>(std::deque<std::string>{
		...
		" how are"s,
		"you?"s
	})), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 35, "main"s));
	
	std::string str2 = "Hello, World!"s;
	
	Main::assert(str2.substr(7, 5) == "World"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 38, "main"s));
	...
	Main::assert(tempLeft == "World"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 39, "main"s));
	Main::assert(HxString::toLowerCase(str2) == "hello, world!"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 41, "main"s));
	Main::assert(HxString::toUpperCase(str2) == "HELLO, WORLD!"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 42, "main"s));
	
	std::string toolsStr = "Hello world!"s;
	
	Main::assert(toolsStr.find("world"s) != -1, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 47, "main"s));
	Main::assert(StringTools::endsWith(toolsStr, "world!"s), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 48, "main"s));
	...
	Main::assert(tempLeft1 == 72, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 50, "main"s));
	...
	Main::assert(tempLeft2 == -1, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 51, "main"s));
	Main::assert(StringTools::hex(0) == "0"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 53, "main"s));
	Main::assert(StringTools::hex(12) == "C"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 54, "main"s));
	Main::assert(StringTools::hex(-24) == "FFFFFFE8"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 55, "main"s));
	Main::assert(StringTools::hex(12, 4) == "000C"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 56, "main"s));
	Main::assert(StringTools::hex(100, 4) == "0064"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 57, "main"s));
	
	std::string html = "<button onclick=\"doThing()\">My Button ✨</button>"s;
	
	Main::assert(StringTools::htmlEscape(html) == "&lt;button onclick=\"doThing()\"&gt;My Button ✨&lt;/button&gt;"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 60, "main"s));
	Main::assert(StringTools::htmlEscape(html, true) == "&lt;button onclick=&quot;doThing()&quot;&gt;My Button ✨&lt;/button&gt;"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 61, "main"s));
	Main::assert(StringTools::htmlUnescape("&amp;"s) == "&"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 63, "main"s));
	Main::assert(StringTools::htmlUnescape(StringTools::htmlEscape(html)) == html, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 64, "main"s));
	Main::assert(StringTools::startsWith(toolsStr, "Hello"s), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 66, "main"s));
	Main::assert(0 == 0, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 68, "main"s));
	Main::assert(!(65 == 0), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 69, "main"s));
	Main::assert(StringTools::isSpace(" "s, 0), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 71, "main"s));
	...
	Main::assert(StringTools::isSpace("\n"s, 0), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 73, "main"s));
	Main::assert(StringTools::isSpace("\r"s, 0), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 74, "main"s));
	Main::assert(StringTools::isSpace("Hello world!"s, 5), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 75, "main"s));
	
	{
		...
		Main::assert(result == "Hello"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 83, "main"s));
	};
	{
		int it_offset = 0;
		std::string it_s = "Hello"s;
		...
		Main::assert(count == 10, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 95, "main"s));
		Main::assert(result == "Hello"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 96, "main"s));
	};
